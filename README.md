...
- Convertir imagen: carga un diseño digital PNG, JPEG o WebP desde **Documento → Convertir imagen**. La aplicación detecta localmente las cuentas, descarta el fondo y las anotaciones, agrupa colores similares y muestra una vista previa editable con zoom sincronizado. El resultado reserva cinco posiciones vacías por cada lado y sus colores pasan a la paleta activa; la imagen original queda como referencia flotante y toda la importación se puede deshacer con `Ctrl+Z`.
