...
- Convertir imagen: carga un diseño digital PNG, JPEG o WebP desde **Documento → Convertir imagen**. La aplicación calibra automáticamente la tolerancia del fondo, detecta localmente las cuentas, descarta el fondo y las anotaciones, agrupa colores similares y muestra una vista previa editable con zoom sincronizado. La tolerancia elegida queda visible, se puede corregir con el deslizador o volver a calcular con **Autoajustar**. El resultado reserva cinco posiciones vacías por cada lado y sus colores pasan a la paleta activa; la imagen original queda como referencia flotante y toda la importación se puede deshacer con `Ctrl+Z`.
...
- Exportación: elige entre imagen PNG o GIF animado. El PNG se mantiene transparente o con fondo de color y, si la guía está visible, incluye sus números sin las líneas. El GIF muestra los números y anima las líneas del recorrido.
- Pantalla completa: usa el botón de las cuatro esquinas junto a los controles de zoom para ampliar el área del lienzo; pulsa `Esc` para salir.
